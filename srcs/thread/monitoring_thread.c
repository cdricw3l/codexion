...
/*   Updated: 2026/08/04 13:28:51 by cebouhad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int check_timestamp(t_coder *coder ,clock_t last_c, int *params)
{
    ...
    if(diff - params[time_to_compile]  > params[time_to_burnout] && coder->nb_of_compil > 0 && coder->nb_of_compil < params[number_of_compiles_required])
    {
